    ...
    def on_show(self):
        ...
        if is_intel:
            for line in [
                ...
                "    No Sequoia/Tahoe build exists upstream — use for",
                "    Sonoma or earlier only.",
                "    For real native WiFi on Sequoia/Tahoe, swap in a",
                "    genuine Apple-supported Broadcom card (e.g. BCM94360CD,",
                "    DW1560) instead — it uses macOS's built-in AirPort",
                "    driver and needs no version-specific kext at all.",
                "",
                "  None",
