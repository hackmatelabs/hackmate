...
def _detect_cpu() -> tuple[str, str, int, str]:
    ...
    if vendor == "intel":
        ...
        if m:
            num = m.group(1)
            d = int(num[0]) if len(num) == 4 else int(num[:2])
        ...
        codename_map = {
            ...
            10:"Comet Lake", 11:"Tiger Lake", 12:"Alder Lake", 13:"Raptor Lake", 14:"Raptor Lake Refresh"
        }
...
def _detect_platform() -> str:
    chassis = _ps("(Get-WmiObject Win32_SystemEnclosure).ChassisTypes")
